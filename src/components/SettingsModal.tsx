  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-6 text-slate-100 relative">
        ...
        <h3 className="text-lg font-bold text-white mb-1">Timer Settings</h3>
        <p className="text-xs text-slate-400 mb-6">Customize your study intervals and alerts.</p>
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1 font-medium">Study Focus</label>
                <input
                  type="number"
                  min="1"
                  max="120"
                  ...
                  className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-xl text-center text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>

              <div>
                <label className="block text-xs text-slate-300 mb-1 font-medium">Short Break</label>
                <input
                  type="number"
                  min="1"
                  max="60"
                  ...
                  className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-xl text-center text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>

              <div>
                <label className="block text-xs text-slate-300 mb-1 font-medium">Long Break</label>
                <input
                  type="number"
                  min="1"
                  max="90"
                  ...
                  className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-xl text-center text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-300 font-medium">Sound chime on completion</span>
              <input
                type="checkbox"
            ...
            {draft.soundEnabled && (
              <div className="flex items-center gap-3 pt-1">
                ...
                <button
                  type="button"
                  onClick={testAudio}
                  className="px-2.5 py-1 text-xs bg-slate-800 hover:bg-slate-700 rounded-lg text-slate-300 border border-slate-700 whitespace-nowrap"
                >
                  Test
                </button>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-300 font-medium">Auto-start break when study finishes</span>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs text-slate-300 font-medium">Auto-start study when break finishes</span>
              <input
                type="checkbox"
